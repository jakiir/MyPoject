...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/js/scrollable.css"/>
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/css/jcontent.css">
...
<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/js/header_image.js"></script>
<!--<script type="text/javascript" src="<?php //bloginfo('template_url'); ?>/js/jquery.jcontent.0.8.min.js"></script>-->

<script type="text/javascript" language="javascript">
/*$("document").ready(function(){
$("div#carouselContainer").jContent({width: 975,
height: 120,
duration: 500,
auto: true,
