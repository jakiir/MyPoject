...
<?php if($banner_image): ?>
<h1 id="mainVisual"><span class="bannerPageTitle"><h3><?php echo $postTitle; ?></h3></span><img src="<?php echo $banner_image; ?>" alt="<?php echo $postTitle; ?>" width="975" height="180"></h1>
<?php endif; ?>
