...
<section id="footerModule_News" class="footerModule_LinkList">
	...
	<?php 		
			...
			$ffostdate = mysql2date('M j, Y',get_field('date_this'));
		...
		?> 
			...
			<li class="blankLink">
				<a href="<?php echo $postPermalink; ?>" target="_blank">
						<span class="inner">
			<span class="date"><em><?php echo $ffostdate; ?></em></span>
...
<div class="right">
	<a href="<?php echo home_url('/'); ?>"><img src="<?php bloginfo('template_url'); ?>/images/logo/site_logo_pagefooter.png" alt="RIKEN BRAIN SCIENCE INSTITUTE (RIKEN BSI)" width="416" height="21"></a>
</div>
<div class="cl"></div>
<p style="margin-top: 26px;">
	<small>
	Copyright ©  BIOTECHNOLOGY & GENETIC ENGINEERING  All Rights Reserved . Developed by. <a class='noDesignUrl' href='http://bdinfobiz.com' target='_blank' title='BDINFOBIZ LIMITED' alt='BDINFOBIZ LIMITED'>BDINFOBIZ LIMITED</a>
	</small>		
</p>
</footer>
